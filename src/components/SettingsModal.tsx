...
import { Employee, CompanySettings, AppData, WorkShift, LateDeductionMode } from '../types';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'shifts' | 'employees' | 'branding' | 'deductions' | 'backup'>('shifts');
