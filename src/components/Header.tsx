        ...
        <div className="flex items-center justify-between h-14 md:h-16 gap-3">
          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1.5 text-[11px] text-slate-500 truncate mt-0.5">
                ...
                <span className="hidden sm:inline-block">{settings.directorName || 'لوحة المدير العام'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            >
              {connectionStatus === 'connected' ? (
                <>
                  ...
                  <span className="hidden lg:inline">مزامنة مباشرة</span>
                </>
              ) : connectionStatus === 'reconnecting' ? (
                <>
                ...
                <>
                  ...
                  <span className="hidden lg:inline">حفظ محلي</span>
                </>
              )}
            </div>
            ...
            >
              ...
              <span className="hidden sm:inline">كشف الحضور والغياب</span>
            </button>
            ...
            {/* Detailed Employee Statement PDF Button */}
            {onOpenDetailedStatement && (
              <button
              ...
              >
                ...
                <span className="hidden sm:inline">كشف تفصيلي (PDF)</span>
              </button>
            )}

            {/* Monthly Payroll Report Button */}
            <button
            ...
            <button
              ...
              title="الإعدادات، الشفتات، الموظفين، وتصفير البيانات"
            >
